...
from wiki2video.methods.remotion_animation import RemotionMethod
from wiki2video.dao.working_block_dao import WorkingBlockDAO
from wiki2video.schema.schema import ScriptBlock, GenerationResult
...
def example_5_video_as_input():
    ...
    dao = WorkingBlockDAO()
    from wiki2video.schema.schema import WorkingBlock, WorkingBlockStatus
